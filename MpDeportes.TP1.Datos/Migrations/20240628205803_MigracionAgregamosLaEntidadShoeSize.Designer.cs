...
namespace MpDeportes.TP1.Datos.Migrations
{
    ...
    [Migration("20240628205803_MigracionAgregamosLaEntidadShoeSize")]
    partial class MigracionAgregamosLaEntidadShoeSize
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MpDeportes.TP1.Entidades.ShoeSize", b =>
                {
            ...
            modelBuilder.Entity("MpDeportes.TP1.Entidades.ShoeSize", b =>
                {
                    b.HasOne("MpDeportes.TP1.Entidades.Shoe", "Shoe")
                        .WithMany("ShoesSizes")
                        .HasForeignKey("ShoeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MpDeportes.TP1.Entidades.Size", "Size")
                        .WithMany("ShoesSizes")
